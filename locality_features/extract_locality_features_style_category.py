...
def generate_category_locality_matrix(split_name, chunk_size):
    ...
    log_file_path = f'{target_folder}{split_name}_category_locality_shapes.txt'
...
def generate_source_locality_matrix(split_name, chunk_size):

    filename = f'{target_folder}{split_name}train.txt.source.npy'
    file_path = Path(filename)
    ...
    with open(f'{target_folder}{split_name}.txt.source') as test_section_file, \
...
generate_source_locality_matrix('test', chunk_size)
generate_source_locality_matrix('valid', chunk_size)
