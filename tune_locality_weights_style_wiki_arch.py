...
class WeightedDist(torch.nn.Module):
    ...
    def forward(self, context_vec, dist, pkg_l, 
                #proj_l, 
                idx_mask):
        """
        """
...
valid_dataset = TensorDataset(context_vecs, dists, pkg_locality,
                              #proj_locality,
                              index_masks)

test_dataset = TensorDataset(test_context_vecs, test_dists, test_pkg_locality,
                             #test_proj_locality, 
                             test_index_masks)
bsz = 10000
